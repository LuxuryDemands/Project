...
public class ReservationListDBTest {
        ...
        public static void main(String[] args) throws DuplicateReservationException {
                 ...
                 String roomFilename="datafiles/database/testRooms.txt";
                 String customerFilename="datafiles/database/testCustomers.txt";
                 String reservationFilename="datafiles/database/testReservations.txt";
                 SequentialTextFileList myList = new
                 SequentialTextFileList(roomFilename,customerFilename,reservationFilename);
...
//              System.out.println("\n\n\n");
                ...
                // test3
                /*
                 * //disconnect try { testDisconnect(myDB); } catch (IOException e) { //
                 * TODO Auto-generated catch block e.printStackTrace(); }
                 * System.out.println("\n>>>disconnected!");
                 * 
                 * //reconnect: myDB = new ReservationListDB(new
                 * SequentialTextFileList(roomFilename,customerFilename,
                 * reservationFilename));
                 * 
                 * System.out.println("\n>>>reconnected!\n"); testToString(myDB);
                 */
...
//               testGetFreeRooms2();
        ...
        public static void testToString(ReservationListDB myDB) // constructor and
                                                                                                                        // toString test
        {
        ...
        public static void testBinarySearch(ReservationListDB myDB) // binary search
                                                                                                                                // test
        {
