...
public enum DawsonHotelFactory implements HotelFactory {
	 ...
	 * @return DawsonCustomer Object of DawsonCustomer with params firstName,
	 *         lastName, email.
	 */
	 ...
	 * @param number
	 *            Credit card number
	 * @return CreditCard Returns a CreditCard object with the card type and
	 *         credit card number.
	 */
	 ...
	 * @param outDay
	 *            Check out date: day
	 * @return DawsonReservation Returns a Reservation object with params:
	 *         aCustomer, aRoom, inYear, inMonth, inDay, outYear, outMonth,
	 *         outDay
	 */
