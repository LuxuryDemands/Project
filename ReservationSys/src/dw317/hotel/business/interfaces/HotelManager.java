...
public interface HotelManager extends Serializable {
	 ...
	 */
	void cancelReservation(Reservation reservation) throws NonExistingReservationException;
	 ...
	 */
	Optional<Reservation> createReservation(Customer customer, LocalDate checkin, LocalDate checkout,
			RoomType roomType);
	 ...
	 */
	Customer findCustomer(String email) throws NonExistingCustomerException;
	 ...
	 */
	Customer registerCustomer(String firstName, String lastName, String email) throws DuplicateCustomerException;
	 ...
	 *             if the customer with the given e-mail cannot be found
	 */
	Customer updateCreditCard(String email, String cardType, String cardnumber) throws NonExistingCustomerException;
